...
class Chats: UICollectionViewController, UITextFieldDelegate {
    ...
    //create text field to write messages
   ...
   func setUpInput(){
        ...
        container.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant:  -60).isActive = true
    ...
    //send the message and save it to the firebase
